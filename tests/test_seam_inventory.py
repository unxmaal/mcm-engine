...
EXPECTED_SQL_SITES_BY_FILE: dict[str, int] = {
    ...
    "adapters/sqlite/storage.py":  54,  # +5 issue #21; +2 issue #37 (record_token_event INSERT + token_totals SELECT)
    ...
    "adapters/postgres/storage.py": 55,  # +5 issue #21; +2 issue #37 (record_token_event INSERT + token_totals SELECT)
